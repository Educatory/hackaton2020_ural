...
//    };
    ...
    var _progressPercentage = function(element, radius, border) {
        ...
        if(element) {
            ...
            var d3Container = d3.select(element),
                startPercent = 0,
                fontSize = 22,
                endPercent = $(element).attr('data-percent'),
                twoPi = Math.PI * 2,
                formatPercent = d3.format('.0%'),
                boxSize = radius * 2;
                foregroundColor = '#66bb6a';
    ...
    return {
        ...
        initProgress: function() {
            _progressPercentage('#sveden_progress_percentage', 46, 3);
        }
